...
GLfloat lightPos[LIGHT_COUNT][4] = {
    {-75.0f, 150.0f, -50.0f, 0.0f},
    {105.0f, 150.0f, 50.0f, 0.0f},
    {-30.0f, 150.0f, -150.0f, 0.0f},
    {5.0f, 150.0f, 0.0f, 0.0f},
};
...
void KeyboardHandler(unsigned char key, int x, int y) {
  switch (key) {
  case 'r':
    activeLightIndex = (activeLightIndex + 1) % LIGHT_COUNT;
    SetupRC();
    break;
  default:
    break;
...
void RenderScene(void) {
  ...
  glLightfv(GL_LIGHT0, GL_POSITION, lightPos[activeLightIndex]);
  ...
  glPushMatrix();
  glTranslatef(lightPos[activeLightIndex][0], lightPos[activeLightIndex][1],
               lightPos[activeLightIndex][2]);
  glColor3ub(255, 0, 0);
